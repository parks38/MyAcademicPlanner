    ...
    <!-- //nav -->
        ...
        <div class = "contianertable">
            <table style = "text-align: center;"">
                <thead> <!--테이블의 속성을 알려준다 -->
                    <tr> <!-- 행: 한줄 -->
                        <th style = "background-color: #B5c7d3; text-align : center; width: 50px;"> 수강 강좌 </th>
                        <th style = "background-color: #B5c7d3; text-align : center;"> 이름  </th>
                        <th style = "background-color: #B5c7d3; text-align : center;"> 이메일  </th>
                        <th style = "background-color: #B5c7d3; text-align : center;"> Github 주소  </th>
                    </tr>
                </thead>
                    <tbody>
                       <%--  <!-- <%
